		...
		<nav class="sidebar-nav">
			<div class="nav-section">
				...
				<a href="{{ route('pengguna.artikel') }}"
					class="nav-link {{ request()->routeIs('pengguna.artikel') ? 'active' : '' }}">
					<i class="bi bi-journal-text"></i>
					<span>Artikel Edukasi</span>
				</a>
				<a href="{{ route('pengguna.konsultasi') }}"
					class="nav-link {{ request()->routeIs('pengguna.konsultasi') ? 'active' : '' }}">
			...
			<div class="nav-section">
				...
				<a href="{{ route('pengguna.pengaturan') }}"
					class="nav-link {{ request()->routeIs('pengguna.pengaturan') ? 'active' : '' }}">
		...
		<header class="admin-header">
			<div class="header-left">
				@if (View::hasSection('header_action'))
					@yield('header_action')
				@else
					<button type="button" class="btn btn-toggle-sidebar" id="toggleSidebar"
						onclick="return window.__momspireToggleSidebar(event)">
